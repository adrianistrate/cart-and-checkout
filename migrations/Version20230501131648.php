 ...
 */
final class Version20230501131648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD owner_id INT DEFAULT NULL AFTER id');
        ...
        $this->addSql('ALTER TABLE user CHANGE credit credit NUMERIC(10, 2) DEFAULT \'0\' NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user CHANGE credit credit NUMERIC(10, 2) DEFAULT \'0.00\' NOT NULL');
